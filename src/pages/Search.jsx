  ...
  useEffect(() => {
    ...
    const get_news = async () => {
      ...
      try {
        let url = "";
        if (search === "") {
          url = `https://newsapi.org/v2/everything?sortBy=publishedAt&page=${page}&pageSize=${pageSize}&language=en&apiKey=5b4b4dd3f4f84bc3b1d259f6c1d123b5`;
        } else {
          url = `https://newsapi.org/v2/everything?sortBy=publishedAt&page=${page}&pageSize=${pageSize}&language=en&q=${search}&apiKey=5b4b4dd3f4f84bc3b1d259f6c1d123b5`;
        }
