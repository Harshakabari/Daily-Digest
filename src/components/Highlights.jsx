...
function Highlights({ stats }) {
  return (
    <div className="bg-sky-400 p-2 text-slate-200 flex flex-col justify-start items-center rounded-md ">
      ...
      {stats.title === "Humidity" ? (
        <div className="w-full mt-4 bg-gray-200 rounded-full h-1.5 mb-4 dark:bg-gray-500">
          <div
            className="bg-yellow-600 h-1.5 rounded-full dark:bg-yellow-50"
