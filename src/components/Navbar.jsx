      ...
      <nav className="flex flex-col bg-slate-900 p-6 h-min relative">
        <div className="w-full flex justify-between overflow-hidden">
          <div className="w-max flex items-center flex-shrink-0 text-white mr-6 gap-5">
            <span className="flex items-center gap-3 font-semibold text-xl tracking-tight">
              <FaNewspaper className="text-3xl" /> DailyDigest
            </span>
            <div className="w-full hidden lg:flex items-center">
              ...
              <Link to="/Weather">
                 <button className='bg-teal-200 text-black mr-3
                    p-[5px] items-center rounded-full border-4 border-teal-200 text-[20px]
                    hover:bg-white hover:text-black hover:duration-300'>
              ...
              <Link
                to="/User"
                className="block lg:inline-block lg:mt-0 text-teal-200 hover:text-white  lg:mx-[450px] text-4xl"
              >
                <CgProfile></CgProfile>
              </Link>
            </div>
        ...
        >
         <div className="w-full flex items-center">
          ...
          <Link
            to="/User"
            className="block lg:inline-block lg:mt-0 text-teal-200 text-lg hover:text-white mr-4"
            onClick={() => {
              setMenuOn(!menuOn);
            }}
           >
